...
//   u_shape = vec4(0.58, 0.20, 0.50, 0.00)
//   u_surface = vec4(2.40, 0.81, 0.00, 1.00)
//   u_finish = vec4(0.00, 0.00, 0.000, 0.01)
//   u_transform = vec4(707.0, 2.51, 0.00, 0.0)
//   u_space = vec4(0.06, 0.60, pointer x, pointer y)
